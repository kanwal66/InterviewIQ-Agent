...
${index === 2 ? "rotate-[-3deg]" : ""}
                  ...
                  <div className='pt-10 text-center'>
                    <div className='text-xs text-green-600 font-semibold mb-2 tracking-wider'>{items.step}</div>
            ...
            <div className='grid md:grid-cols-2 gap-10'>
              {
                [
                  ...
                  },
                  {
                    ...
                    desc: "Projects-specific questions bassed on uploaded resume. "
                  },
                  {
                    image: pdfImg,
                    icon: <BsFileEarmarkText size={20} />,
                  ...
                  <motion.div key={index}
                    ...
                    <div className='flex flex-col md:flex-row items-center gap-8'>
                      <div className='w-full md:w-1/2 flex justify-center'>
                        <img src={item.image} alt="{item.title}" className='w-full h-auto object-contain mx-h-64' />
                      </div>
