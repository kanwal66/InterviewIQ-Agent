...
const navigate = useNavigate()
  ...
  const skills = [
    ...
    { label: "Correcorrectness", value: correctness },
  ];
  ...
  if (finalScore >= 8) {
    performanceText = "Ready for job oppertunties.";
  ...
  return (
    <div className='min-h-screen bg-linear-to-br from-gray-50 to-green-50 px-4 sm:px-6 lg:px-10 py-8'>
      <div className='mb-8 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4'>
        ...
        <button
        onClick={downloadPDF}
        className='bg-emerald-600 hover:bg-emerald-700 text-white py-3 px-3 rounded-xl shadow-md transition-all duration-300 font-semibold text-sm sm:text-base text-nowrap'>Download PDF</button>
      </div>
 ...
 <div className='relative w-20 h-20 sm:w-25 sm:h-25 mx-auto'>
      ...
      <div className='mt-4'>
        ...
        <p className='text-gray-500 text-xs sm:text-sm mt-1'>{shortTagline}</p>
          ...
          initial={{ opacity: 0}}
          animate={{ opacity: 1}}
          className='bg-white rounded-2xl sm:rounded-3xl shadow-lg p-6 sm:p-8 mt-4'>
                ...
                skills.map((s,i)=>(
                  <div key={i}>
                    <div className='flex justify-between mb-2 text-sm sm:text-base'>
                      ...
                      <span className='font-semibold text-green-600 '>{s.value}
              ...
              {questionWiseScore.map((q,i)=>(
                <div key={i} className='bg-gray-50 p-4 sm:p-6 rounded-xl sm:rounded-2xl border border-gray-200'>
                  ...
                  <div className='flex flex-col sm:flex-row sm:justify-between sm:items-start gap-3 mb-4'>
                    ...
                    <div> <p className='text-xs text-gray-400'>Question {i + 1}</p>
