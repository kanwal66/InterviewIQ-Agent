...
function Step1SetUp({ onStart }) {
    ...
    const handleUploadResume = async () => {
        ...
        try {
            ...
            setExprience(result.data.experience || "");
                ...
                <motion.div
                    ...
                    <div className='space-y-6'>
                        ...
                        <div className='relative'>
                            ...
                            <input type='text' placeholder='Exprience (eg.2 years)' className='w-full pl-12 pr-4 py-3 border border-gray-200 rounded-xl focus:ring-2 focus:ring-green-500 outline-none transition'
                                onChange={(e) => setExprience(e.target.value)} value={experience} />
